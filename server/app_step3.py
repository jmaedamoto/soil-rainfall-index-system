...
# Import API layer
from src.api.routes import soil_rainfall_bp
...
# Register API layer blueprints
app.register_blueprint(soil_rainfall_bp)

# Initialize service layer (for legacy endpoints)
